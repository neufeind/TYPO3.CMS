 ...
 ***************************************************************/
require_once \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath('TYPO3.CMS.Scheduler') . 'interfaces/interface.tx_scheduler_additionalfieldprovider.php';
