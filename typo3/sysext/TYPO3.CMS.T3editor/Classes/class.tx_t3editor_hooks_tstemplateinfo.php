 ...
 * typo3/sysext/TYPO3.CMS.T3editor/Classes/Hook/TypoScriptTemplateInfoHook.php
 */
require_once \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath('TYPO3.CMS.T3editor') . 'Classes/Hook/TypoScriptTemplateInfoHook.php';
?>