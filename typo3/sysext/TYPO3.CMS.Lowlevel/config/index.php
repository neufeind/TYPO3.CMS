 ...
 * typo3/sysext/TYPO3.CMS.Lowlevel/Classes/View/ConfigurationView.php
 */
require_once \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath('TYPO3.CMS.Lowlevel') . 'Classes/View/ConfigurationView.php';
// Make instance:
