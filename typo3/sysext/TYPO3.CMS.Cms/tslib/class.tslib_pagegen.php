 ...
 * typo3/sysext/TYPO3.CMS.Frontend/Classes/Page/PageGenerator.php
 */
require_once \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath('TYPO3.CMS.Frontend') . 'Classes/Page/PageGenerator.php';
/**
