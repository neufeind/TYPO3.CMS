 ...
 * typo3/sysext/TYPO3.CMS.Frontend/Classes/Controller/ShowImageController.php
 */
require_once \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath('TYPO3.CMS.Frontend') . 'Classes/Controller/ShowImageController.php';
// Make instance:
