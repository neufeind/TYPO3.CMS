 ...
 * typo3/sysext/TYPO3.CMS.Openid/Classes/OpenidEid.php
 */
require_once \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath('TYPO3.CMS.Openid') . 'Classes/OpenidEid.php';
