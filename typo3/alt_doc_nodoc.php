...
require_once \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath('TYPO3.CMS.Opendocs') . 'class.tx_opendocs.php';
/*
 * @deprecated since 6.0, the classname SC_alt_doc_nodoc and this file is obsolete
 * and will be removed with 6.2. The class was renamed and is now located at:
 * typo3/sysext/TYPO3.CMS.Backend/Classes/Controller/NoDocumentsOpenController.php
 */
require_once \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath('TYPO3.CMS.Backend') . 'Classes/Controller/NoDocumentsOpenController.php';
// Make instance:
